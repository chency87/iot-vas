...
def get_item(nmap_service):
    ...
    if 'Vendor' in jservice.keys():
        ...
        save_device_info_from_nse(vendor, product_name, serial_number, device_type, product_code, revision, service,
                                  protocol, device_ip)
...
def save_device_info_from_nse(vendor, product_name, serial_number, device_type, product_code, revision, service,
                              protocol, device_ip):
    add_update_device(id=None, vendor=vendor, product_name=product_name, serial_number=serial_number,
                      device_type=device_type, product_code=product_code, revision=revision, service=service,
                      protocol=protocol, device_ip=device_ip)
